...
> **Versión del producto:** Xabia Agent Core **v1.0.269** (agosto 2026)  
...
1. Descargue el ZIP de **Xabia Agent Core** (`xabia-agent-core-1.0.269.zip` o paquete retail equivalente).
