...
| [manual-usuario-xabia-core.md](./manual-usuario-xabia-core.md) | **Manual Core** (**v1.0.283**): RAG Cloud (expansiones de palabras clave, densificado UTF-8), Playground alt agnóstico, activación PRO retail, actualizaciones, Polar, listados/pasaporte, WPML, Smart QR, Wallet. PDF/HTML en [xabia.ai/docs/](https://xabia.ai/docs/manual-usuario-xabia-core.pdf). |
