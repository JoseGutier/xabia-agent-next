 ...
 */
class ListHyperparameterTuningJobsResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        return $this->hyperparameter_tuning_jobs;
    }
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AIPlatform\V1\HyperparameterTuningJob::class);
        $this->hyperparameter_tuning_jobs = $arr;
