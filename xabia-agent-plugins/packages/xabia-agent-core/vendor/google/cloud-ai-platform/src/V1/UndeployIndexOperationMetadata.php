 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1.UndeployIndexOperationMetadata</code>
 */
class UndeployIndexOperationMetadata extends \Google\Protobuf\Internal\Message
{
    /**
