 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1.PurgeExecutionsResponse</code>
 */
class PurgeExecutionsResponse extends \Google\Protobuf\Internal\Message
{
    /**
