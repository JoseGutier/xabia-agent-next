 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1.MutateDeployedIndexOperationMetadata</code>
 */
class MutateDeployedIndexOperationMetadata extends \Google\Protobuf\Internal\Message
{
    /**
