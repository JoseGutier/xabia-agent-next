 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1.PurgeContextsMetadata</code>
 */
class PurgeContextsMetadata extends \Google\Protobuf\Internal\Message
{
    /**
