 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1.UpdateTensorboardOperationMetadata</code>
 */
class UpdateTensorboardOperationMetadata extends \Google\Protobuf\Internal\Message
{
    /**
