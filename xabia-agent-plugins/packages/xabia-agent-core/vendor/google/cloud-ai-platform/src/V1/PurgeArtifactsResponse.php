 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1.PurgeArtifactsResponse</code>
 */
class PurgeArtifactsResponse extends \Google\Protobuf\Internal\Message
{
    /**
