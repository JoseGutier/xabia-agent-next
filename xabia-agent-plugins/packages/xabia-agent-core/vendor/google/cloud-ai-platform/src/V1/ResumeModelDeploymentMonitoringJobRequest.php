 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1.ResumeModelDeploymentMonitoringJobRequest</code>
 */
class ResumeModelDeploymentMonitoringJobRequest extends \Google\Protobuf\Internal\Message
{
    /**
