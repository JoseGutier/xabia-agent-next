...
class SpecialistPoolServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.aiplatform.v1.SpecialistPoolService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ .
                '/../resources/specialist_pool_service_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ .
                '/../resources/specialist_pool_service_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ .
                '/../resources/specialist_pool_service_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../resources/specialist_pool_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    {
        if (self::$specialistPoolNameTemplate == null) {
            self::$specialistPoolNameTemplate = new PathTemplate(
     ...
     */
    public static function specialistPoolName(
        $project,
        $location,
        $specialistPool
    ) {
