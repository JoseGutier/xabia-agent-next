<?php
/**
 * Plugin Name: Xabia Agent LITE - AI Chatbot & Local Assistant
 * Plugin URI: https://xabia.ai
 * Description: Agente de IA para WordPress con ingesta de CSV y scraper local. BYOK con Google Gemini.
 * Version: 1.0.0-lite
 * Author: Digixop
